 <nav id="main-nav" class="main-nav">
                    <ul id="menu-primary-menu" class="menu">
                      ...
                      <li class="menu-item-has-children">
                        <a href="platform.html">Platforms<svg
                            class="s1"
                            width="8"
                            height="10"
                            viewBox="0 0 8 10"
                      ...
                      <li class="menu-item">
                        <a href="exchange.html">Markets<svg
                            class="s1"
                            width="8"
                            height="10"
                            viewBox="0 0 8 10"
                      ...
                      <li class="menu-item-has-children">
                        <a href="#">Trade <i class="fas fa-sort-desc" aria-hidden="true"></i></a><ul class="sub-menu">
                          <li class="menu-item">
                            <a href="blog-default.html">Buy Assets</a>
                          </li>
                          <li class="menu-item">
                            <a href="blog-grid-v1.html">Sell Assets</a>
                          </li></ul>
                      ...
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          <li class="menu-item">
                            <a href="blog-default.html">About xTradeSecurity</a>
                          </li>
                          <li class="menu-item">
                            <a href="blog-grid-v1.html">Privacy policy</a>
                          </li>
                          <li class="menu-item">
                            <a href="blog-grid-v2.html">Terms of use</a>
                          </li>
                          <li class="menu-item">
                            <a href="blog-list.html">Affiliate policy</a>
                          </li>
                          <li class="menu-item">

 <nav id="main-nav" class="main-nav">
                    <ul id="menu-primary-menu" class="menu">
                      ...
                      <li class="menu-item-has-children">
                        <a href="platform.php">Platforms<svg
                            class="s1"
                            width="8"
                            height="10"
                            viewBox="0 0 8 10"
                      ...
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          <li class="menu-item">
                            <a href="blog-default.php">About xTradeSecurity</a>
                          </li>
                          <li class="menu-item">
                            <a href="blog-grid-v1.php">Privacy policy</a>
                          </li>
                          <li class="menu-item">
                            <a href="blog-grid-v2.php">Terms of use</a>
                          </li>
                          <li class="menu-item">
                            <a href="blog-list.php">Affiliate policy</a>
                          </li>
                          <li class="menu-item">
